#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Tax Havens / Sovereignty Arbitrage
==================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Tax Havens (Sovereignty Arbitrage).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "tax_havens",
    "domain_name": "Tax Havens",
    "theorem": "Sovereignty Arbitrage",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 492.0,
    "channels": {
        "C1_fiscal_drain": {
            "dist": "normal",
            "low": 400,
            ...
            "high": 600,
            "weight": 0.16,
            "description": "Direct tax revenue lost to profit shifting"
        },
        "C2_public_services": {
            "dist": "lognormal",
            "low": 450,
            ...
            "high": 850,
            "weight": 0.21,
            "description": "Public services degradation from lost revenue"
        },
        "C3_inequality": {
            "dist": "lognormal",
            "low": 350,
            ...
            "high": 750,
            "weight": 0.18,
            "description": "Inequality amplification, wealth concentration"
        },
        "C4_financial_stability": {
            "dist": "lognormal",
            "low": 300,
            "mid": 480,
            "high": 700,
            "weight": 0.17,
            "description": "Financial system opacity, crisis transmission"
        },
        "C5_governance": {
            "dist": "lognormal",
            "low": 250,
            ...
            "high": 600,
            "weight": 0.15,
            "description": "Sovereignty erosion, regulatory race to bottom"
        },
        "C6_developing_countries": {
            "dist": "lognormal",
            "low": 280,
            "mid": 500,
            "high": 750,
            "weight": 0.13,
            "description": "Disproportionate impact on Global South fiscal capacity"
        }
    },
